...
cp -pr component.json package.json *.js \
...
%changelog
* Mon Jul 03 2017 Zuzana Svetlikova <zsvetlik@redhat.com> - 1.0.0-2
- rh-nodejs8 rebuild

* Tue Sep 13 2016 Zuzana Svetlikova <zsvetlik@redhat.com> - 1.0.0-1
- Updated with script
